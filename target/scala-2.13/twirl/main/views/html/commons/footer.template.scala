...
Seq[Any](format.raw/*1.1*/("""<footer class="footer pt-3  ">
    <div class="container-fluid">
        <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4 offset-3">
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  SOURCE: app/views/commons/footer.scala.html
                  HASH: 75253f1c47830ba8e148851c7cc4dfb5b993cc6d
                  MATRIX: 998->0
                  LINES: 32->1
                  -- GENERATED --
              */
