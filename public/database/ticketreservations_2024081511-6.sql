...
CREATE TABLE `driving` (
  ...
  `status` enum('arrived','pending') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'pending',
  `created_at` bigint DEFAULT NULL,
  `updated_at` bigint DEFAULT NULL,
  `is_deleted` tinyint(1) DEFAULT '0',
  `deleted_at` bigint DEFAULT NULL,
...
CREATE TABLE `driving_tracking` (
  ...
  `status` enum('pending','arrived') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'pending',
  `created_at` bigint DEFAULT NULL,
  `updated_at` bigint DEFAULT NULL,
  `is_deleted` tinyint(1) DEFAULT '0',
  `deleted_at` bigint DEFAULT NULL,
...
INSERT INTO `driving_tracking` VALUES (1,1,3,6,'arrived',1723710156,1723712579,0,1723710156),(2,1,4,3,'arrived',1723710156,1723712582,0,1723710156),(3,1,5,NULL,'arrived',1723710156,1723712572,0,1723710156),(4,1,6,5,'arrived',1723710156,1723712574,0,1723710156),(5,1,7,4,'arrived',1723710156,1723712584,0,1723710156);
...
CREATE TABLE `schedules` (
  ...
  `passenger_limit` int DEFAULT NULL,
  `driver_id` int DEFAULT NULL,
  `status` enum('pending','inprogress','cancelled','completed','closed') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'pending',
  `created_at` bigint DEFAULT NULL,
  `updated_at` bigint DEFAULT NULL,
  `is_deleted` tinyint(1) DEFAULT '0',
  `deleted_at` bigint DEFAULT NULL,
...
INSERT INTO `schedules` VALUES (1,4,3,'RAB12ST',1724793300,NULL,22,7,'completed',1720265840,1723023000,0,1720265840),(2,4,3,'RAD23T',1721916000,NULL,30,NULL,'pending',1720267114,1720267114,1,1720267182),(3,4,4,'RAD 210 Q',1723742940,NULL,25,7,'pending',1721572353,1723022993,0,1721572353),(4,4,5,'RAE011F',1726768800,NULL,18,7,'pending',1721572377,1723022986,0,1721572377),(5,4,5,'RAD12S',1726156800,NULL,15,7,'pending',1722953996,1723022979,0,1722953996);
...
-- Dump completed on 2024-08-15 11:07:09
